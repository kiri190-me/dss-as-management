...
type IntakeFormProps = {
  ...
  /** Real database customer/End-User/engineer/Product Model options — only
   * non-null in database mode. Type-only import (erased at compile time), so
   * the server-only guard on repair-case-references.ts is never crossed. */
 ...
 */
export default function IntakeForm({ writeSource, referenceData, canRegisterProductModel }: IntakeFormProps) {
