    ...
    return (
      <div className="flex flex-wrap items-center gap-2">
        <button
          ...
          className="rounded-md bg-primary-900 px-3 py-2 text-sm font-medium text-white hover:bg-primary-800 disabled:opacity-50 dark:bg-primary-50 dark:text-zinc-900 dark:hover:bg-primary-200"
        >
