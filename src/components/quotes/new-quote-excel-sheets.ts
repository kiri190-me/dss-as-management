 ...
 *
 * ── 🔴 매쳐 시트는 종류가 정해지지 않는다 ────────────────────────────────
 * 매쳐 양식 한 장을 내자로도 OH 로도 쓴다. 그래서 매쳐만 든 파일은 종류를 맞춰 주지 않고
 * **있는 그대로 알린 뒤 사람이 고르게** 한다.
 * ============================================================================
 */

/**
 * 양식 → 견적서 종류. 🔴 매쳐는 null 이다(머리말). `Record` 라 읽개에 양식이 하나 늘면
 * 컴파일러가 여기를 짚는다.
 */
...
/** 매쳐 양식의 이름표 — 종류 이름표가 없는 유일한 양식이다. */
