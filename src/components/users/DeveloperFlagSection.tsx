          ...
          <table className="w-full min-w-[640px] text-left text-sm">
            <thead>
              <tr className="border-b border-zinc-200 text-xs text-zinc-500 dark:border-zinc-800 dark:text-zinc-400">
                ...
                <th scope="col" className="py-2 px-3 font-medium">개발자 표시</th>
            ...
            <tbody>
              {users.map((user) => (
                <tr key={user.id} className="border-b border-zinc-100 align-top last:border-0 dark:border-zinc-800">
                  ...
                  <td className="py-2 px-3 whitespace-nowrap text-zinc-600 dark:text-zinc-400">{roleText(user)}</td>
                  <td className="py-2 px-3">{renderDeveloperMark(user)}</td>
