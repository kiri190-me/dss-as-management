...
/**
 * Single repair-case resolver for server code.
 ...
 * (a real SQL query) runs at most once per request, no matter how many of
 * those files call this function. This is request-level
 ...
 * like any other unknown id: getRepairCaseById rejects it at its UUID guard
 * before any query runs. Callers get the same "not found" they already
 * handle — no demo branch exists any more, on either read or write.
 *
