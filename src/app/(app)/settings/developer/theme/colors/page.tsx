 ...
 * 개발자 모드 · 화면 토큰 — 색
 * ============================================================================
 * 구조선 래퍼와 우회 배너는 상위 layout.tsx 에 있다. 그래서 **여기서 무엇을
 ...
 * ============================================================================
 */
export default async function DeveloperThemeColorsPage() {
    ...
    <>
      ...
      */}
      ...
      <section className="rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
        {isDatabaseMode ? (
          <ThemeTokenEditor saved={savedThemeTokens} group="colors" />
        ) : (
