...
import MainColorPicker from "@/components/settings/MainColorPicker";
...
export const metadata: Metadata = {
  title: "메인 컬러 | 개발자 모드 | DSS A/S 관리 시스템",
};
 ...
 * 개발자 모드 · 화면 토큰 — 메인 컬러
 * ============================================================================
 * 구조선 래퍼와 우회 배너는 상위 layout.tsx 에 있다. 그래서 **여기서 무슨 색을
 * 저장하든 이 화면 자체는 기본색으로 그려진다** — 색을 고치러 들어온 화면이
 ...
 *
 * 옆의 톤 템플릿 화면과 같은 자료를 그대로 받는다 — 「지금 무슨 메인 컬러를
 * 쓰는가」는 따로 저장하지 않고 저장된 행을 대조해 알아내므로, 이 화면이 서버에서
 * 더 읽어야 할 것이 없다(domain/ui-theme-primary-ramp.ts 머리말).
 * ============================================================================
 */
export default async function DeveloperThemeMainColorPage() {
    ...
    <>
      ...
      */}
      ...
      <section className="rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
        {isDatabaseMode ? (
          <MainColorPicker saved={savedThemeTokens} />
        ) : (
